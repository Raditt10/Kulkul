        ...
        <div class="container mx-auto px-4 relative z-10 pt-28 pb-12">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="section-card glass-effect rounded-2xl p-6 border border-slate-700 hover-lift animate-slide-up">
                            ...
                            <form id="passwordForm" class="space-y-4" method="POST"> 
                                @csrf
                                <div>
                                ...
                                <button type="submit" onclick="toggleComingSoon()"
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-slate-800/30 rounded-xl p-4">
                                <div class="text-center">
                                    ...
                                    <button onclick="toggleComingSoon()" class="mt-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white text-sm rounded-lg hover-lift transition-all duration-300">
                    ...
                    <div class="section-card glass-effect rounded-2xl p-6 border border-slate-700 hover-lift animate-slide-up" style="animation-delay: 0.6s">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            <div class="bg-slate-800/30 rounded-xl p-4 text-center">
                                ...
                                <button onclick="toggleComingSoon()" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-300">
                            ...
                            <div class="bg-slate-800/30 rounded-xl p-4 text-center">
                                ...
                                <button onclick="toggleComingSoon()" class="w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all duration-300">
                            ...
                            <div class="bg-slate-800/30 rounded-xl p-4 text-center">
                                ...
                                <button onclick="toggleComingSoon()" class="w-full px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-all duration-300">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-slate-400"> • Bandung, Indonesia</div>
                    ...
                    <div class="section-card glass-effect rounded-2xl p-6 border border-red-500/50 hover-lift animate-slide-up" style="animation-delay: 0.9s">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="bg-red-900/20 border border-red-500/30 rounded-xl p-4">
                                ...
                                <button onclick="toggleComingSoon()" class="w-full px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all duration-300"> <!-- id="deleteDataBtn" -->
                            ...
                            <div class="bg-red-900/20 border border-red-500/30 rounded-xl p-4">
                                ...
                                <button onclick="toggleComingSoon()" class="w-full px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all duration-300"> <!-- id="deleteAccountBtn" -->
                ...
                <div class="mt-8 text-center animate-slide-up" style="animation-delay: 0.7s">
                    <button id="saveAllSettings" onclick="toggleComingSoon()" class="px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold text-lg rounded-2xl hover-lift hover:from-orange-400 hover:to-red-500 transition-all duration-300 shadow-2xl">
