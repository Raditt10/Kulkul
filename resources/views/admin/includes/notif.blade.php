 <div id="comingSoonNotif" class="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-md px-4 animate-slideDown">
    <div class="glass rounded-2xl p-6 shadow-2xl border border-orange-500/30 relative overflow-hidden">
      ...
      <div class="relative flex items-start gap-4">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-slate-400 mt-2">Progress: 50%</p>
        </div>