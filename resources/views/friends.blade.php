...
<body class="bg-slate-950 overflow-x-hidden">
    ...
    <div id="sidebar" class="fixed top-0 right-0 w-80 h-full backdrop-blur-xl text-white transform translate-x-full transition-transform duration-500 ease-in-out z-50 shadow-2xl border-l border-orange-500/20 bg-slate-900/95 flex flex-col">
        ...
        <ul class="flex-1 overflow-y-auto sidebar-scroll px-6 py-4 space-y-3">
            <li>
                <a href="{{ route('home') }}" class="flex items-center space-x-4 text-slate-300 hover:text-white hover:bg-orange-600/20 transition-all duration-300 hover-lift p-3 rounded-xl">
            ...
            <li>
                <a href="{{ route('friends') }}" class="flex items-center space-x-4 text-white bg-orange-600/30 transition-all duration-300 hover-lift p-3 rounded-xl border border-orange-400/30">
            ...
            <div class="grid md:grid-cols-4 gap-8 text-slate-400">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="{{ route('friends') }}" class="hover:text-orange-400">Friends</a></li>
                    </ul>
                </div>
                <div>
